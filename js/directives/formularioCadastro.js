directivesPadrao.directive('formularioCadastro', ['$compile', 'APIServ', 'APIAjuFor', 'EGFuncoes', function ($compile, APIServ, APIAjuFor, EGFuncoes) {
    return {
        restrict: 'E',
        replace: true,
        template: '',
        link: function (scope, elem) {            
            ...
            if (parametrosLocal != undefined && parametrosLocal.tabelasRelacionadas != undefined) {
                //scope[parametros.raizModelo]['tabelasRelacionadas'] = APIServ.criptografa(angular.toJson(parametrosLocal.tabelasRelacionadas));
                ...
                Object.keys(parametrosLocal.tabelasRelacionadas).map(key => {
                    ...
                    scope[parametros.raizModelo][campo_relacionamento] = valorChaveRelacionamento;
                    ...
                    if (tR.tabelasSubRelacionadas != undefined) {
                        Object.keys(tR.tabelasSubRelacionadas).map(keySR => {
                            ...
                            scope[parametros.raizModelo][campo_subRelacinamento] = valorChaveSubRelacionada;
                        })
                    }
                })
            }
