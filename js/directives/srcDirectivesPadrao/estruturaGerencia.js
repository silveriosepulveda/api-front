...
if (typeof app !== 'undefined') {
    ...
    app.directive('estruturaGerencia', ['$compile', '$base64', '$parse', 'filtroPadrao', 'operadoresConsulta', '$http', 'APIServ', '$filter', 'APIAjuFor', 'EGFuncoes', 'PopUpModal',
     ...
     angular.module('estruturaGerencia', [])
         .directive('estruturaGerencia', ['$compile', '$base64', '$parse', 'filtroPadrao', 'operadoresConsulta', '$http', 'APIServ', '$filter', 'APIAjuFor', 'EGFuncoes', 'PopUpModal',
             function ($compile, $base64, $parse, filtroPadrao, operadoresConsulta, $http, APIServ, $filter, APIAjuFor, EGFuncoes, PopUpModal) {
                 // Implementação simplificada para módulo independente
                 return {
                     restrict: 'E',
                     template: '<div>Estrutura Gerencia - Módulo Independente</div>',
                     link: function (scope, element, attrs) {
                         console.log('EstruturaGerencia carregada como módulo independente');
                     }
                 }
             }
         ]);
