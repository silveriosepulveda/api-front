...
$caminho = conexao::caminhopastausada();

$base_url="";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = 'imagens/diversas/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $caminho . 'imagens/diversas/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = 'imagens/diversas/thumbs/';// $caminho . 'imagens/diversas/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)


/*
$base_url="";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = 'imagens/diversas/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../imagens/diversas/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../imagens/diversas/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
*/
//--------------------------------------------------------------------------------------------------------
